...
if __name__ == '__main__':
    ...
    vve = ViaVarejoExtractor(
        host_website='www.extra.com.br',
        host_api='pdp-api.extra.com.br',
        zipcode='01021-100',
        marketplace_identifier='EX',
        marketplace_name='Extra'
    )
    ...
    if l_products is not None:
        # DataFrame(l_products).to_excel(excel_writer='_products_extra.xlsx', index=False, encoding='utf-8-sig')
