...
if __name__ == '__main__':
    ...
    vve = ViaVarejoExtractor(
        host_website='www.pontofrio.com.br',
        host_api='pdp-api.pontofrio.com.br',
        zipcode='01021-100',
        marketplace_identifier='PF',
        marketplace_name='Ponto Frio'
    )
    ...
    if l_products is not None:
        # DataFrame(l_products).to_excel(excel_writer='_products_pontofrio.xlsx', index=False, encoding='utf-8-sig')
